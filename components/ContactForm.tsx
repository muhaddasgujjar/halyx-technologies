        ...
        <Reveal className={styles.panelBorder}>
          <div className={styles.panel}>
            <div className={styles.grid}>
              <div className={styles.left}>
                <div>
                  <div className={styles.pill}>
                    ...
                    <span className={styles.pillLabel}>Get Started</span>
                  </div>
                  <h2 className={styles.h2}>Let&rsquo;s build your next intelligent product</h2>
                  <div className={styles.rule} aria-hidden="true" />
                  <p className={styles.lead}>
                    Turn your vision into a system that ships, scales, and{" "}
                    <span className={styles.leadStrong}>stands out</span>.
                  </p>
                </div>
              ...
              <div>
                <h3 className={styles.h3}>Let&rsquo;s talk</h3>
